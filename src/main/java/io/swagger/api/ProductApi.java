...
public interface ProductApi {
    ...
    ResponseEntity<Product> createProduct(@Parameter(in = ParameterIn.DEFAULT, description = "Create a new product in the store", required=true, schema=@Schema()) @Valid @RequestBody Product body);


    @Operation(summary = "Retrieve all Products", description = "Returns all products", tags={ "product" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Product.class))),
